...
proc InitOther {} {
	...
	catch {puts stderr "TNBDBG InitOther: before NSMainWindow creation" ; flush stderr} ;# TNBDBG
	angband_load prompt "Initializing: Main Window"
	NSModule::LoadIfNeeded NSMainWindow
	catch {puts stderr "TNBDBG InitOther: NSMainWindow created, main,oop=[Global main,oop]" ; flush stderr} ;# TNBDBG
...
catch {puts stderr "TNBDBG init-other.tcl: sourced, calling InitOther" ; flush stderr} ;# TNBDBG
if {[catch {
	...
	catch {puts stderr "TNBDBG InitOther ERROR: $error\n$::errorInfo" ; flush stderr} ;# TNBDBG
	HandleError $error
}
catch {puts stderr "TNBDBG init-other.tcl: InitOther returned (main,oop exists=[info exists ::Global; expr {![catch {Global main,oop}]}])" ; flush stderr} ;# TNBDBG
