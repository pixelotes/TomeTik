...
extern bool travel_to(int gy, int gx);
extern void travel_step(void);
extern void travel_cancel(void);
extern bool do_cmd_click(int gy, int gx);
extern void click_act_step(void);
...
extern int autoplay_cfg(cptr key, int def);
...
extern void eat_food(int item);
extern void do_cmd_quaff_potion(void);
extern bool quaff_potion(int tval, int sval, int pval, int pval2);
...
extern void store_bot_refresh(int town_num, int store_num);
extern int store_bot_find(int town_num, int store_num, int tval, int sval);
extern int store_bot_buy(int town_num, int store_num, int stock_idx, int amt);
extern s32b store_bot_price(int town_num, int store_num, int stock_idx);
extern s32b store_bot_sell(int town_num, int store_num, int item);
...
extern int get_weaponmastery_skill(void);
extern int get_archery_skill(void);
...
extern void autoplay_spend_skills(void);
